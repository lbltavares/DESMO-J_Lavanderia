...
public class MaquinaLavar extends Entity {
	...
	public void lavar(Cliente cliente) {
		...
		eventoTerminoLavagem = new EventoTerminoLavagem(modeloLavanderia,
		...
		// Atualiza a utilização da máquina de lavar.
		modeloLavanderia.utilizacaoMaquinaDeLavar.update();

		// Atualiza a utilização total da máquina de lavar.
		modeloLavanderia.utilizacaoTotalMaquinaDeLavar.update((long) tempoLavagem);
		
		// Calcula o throughput da máquina de lavar.
		modeloLavanderia.throughput.update((long) tempoLavagem);
	}
